...
class Lists extends Component {
  ...
  loadSortOptions() {
    let optionsSort = [
      { key: 1, label: 'A - Z', value: 'asc_name' },
      { key: 2, label: 'Z - A', value: 'desc_name' },
      { key: 3, label: 'Harga Terendah', value: 'asc_price' },
      { key: 4, label: 'Harga Tertinggi', value: 'desc_price' },
    ];

    this.props.searchConfig.searchUnit == Hooks.APARTMENT ?
      optionsSort.unshift(
        { key: 5, label: 'Rekomendasi', value: 'recommended' },
      )
      :
      optionsSort.unshift(
        { key: 5, label: 'Terbaru', value: 'latest' },
      );
              ...
              <View style={[
                ...
                <View style={[
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={Styles.Colors.grayDark}
                    returnKeyType={'go'}
